...
![w:800](./img/word-equation-1.png)
![w:800](./img/word-equation-2.png)
![w:800](./img/word-equation-3.png)
...
* **表示形式**：**行形式** / **2次元形式** 切替
  ...
  * 行形式：`x=(-b±√(b^2-4ac))/(2a)` のように**1行式**
  * 2次元形式：$x= \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}$ のように分数や根号を**きれいに**表示

---

# ミニ演習（手を動かす）

※ 下の数式をいれて見よう（フォントなどはちがうので式があっていればOK）
...
* テンプレ：`03_Equation.docx`（Moodle配布）
...
* **積分**と**極限**の入力：$\int_0^1 \sqrt{x^2 + a^2} dx$、$\lim_{n\to\infty} (1 + \frac{1}{x})^x = e$
